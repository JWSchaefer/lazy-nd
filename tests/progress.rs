...
fn tests() {
    ...
    t.compile_fail("tests/struct_attributes/dim/08-overdefined.rs");
    ...
    t.compile_fail("tests/struct_attributes/inner/05-incomplete_eq_comma.rs");
    t.compile_fail("tests/struct_attributes/inner/06-overdefined.rs");
}
